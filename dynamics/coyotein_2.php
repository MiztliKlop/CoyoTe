<?php
  ...
  if($conexion){
    ...
    if($cat==1){ //En caso de que la categoría sea uno, es decir cliente
      $id_usuario=  "SELECT id_usuario FROM usuario WHERE categoria=1"; //Selecciona todos los id_usuario que correspondan a esta categoría
      ...
      $id_usuario=  "SELECT id_usuario FROM usuario WHERE categoria=2"; //Selecciona todos los registros que correspondan a esta categoría
      $resp_usu= mysqli_query($conexion, $id_usuario);
      ...
      $id_usuario=  "SELECT id_usuario FROM usuario WHERE categoria=3"; //Selecciona todos los registros que correspondan a esta categoría
      $resp_usu= mysqli_query($conexion, $id_usuario);
      while($rev_usu= mysqli_fetch_array($resp_usu)){ //Se guardan todos los registros que coincidan
        $b[$i]=$rev_usu[0]; //Se guardan los registros hasheados
        $rev_usu[0]=base64_decode($rev_usu[0]);
