...
elseif ( isset($_POST['envioU']) )
{
  ...
  if ($sets=="Sancion") {
    echo "  <p>Modificar: Base De Datos</p>
      <form class='' action='bd1.php' method='post'>
        Usuario a Modificar:  <input type='text' name='nombreU' value='' placeholder='Escriba Correctamente' required><br><br>
        Sancion:<br>
        La tiene:<input type=radio name=sancion value=Si></input><br>
        No la tiene:<input type=radio name=sancion value=No></input>
        ";;
    echo "Sancionar<br>
          <form class='' action=Cafeteria.php method=post>
            Si<input type=radio name=sancio value=Si></input><br>
            No<input type=radio name=sancio value=No></input><br>
            Usuario a Sancionar:<input type='text' name='nombreU' value='' placeholder='Escriba Correctamente' required><br>
