<?php
//Página en caso de que el registro del Administrador haya sido exitoso.
echo "<!DOCTYPE html>
  <head>
    <meta charset='utf-8'>
    <title>CoyoTé</title>
  ...
  <body>"; //Ventana de registro correcto en el caso del administrador
echo  "<h2>Registro correcto</h2>
      <img src='../statics/img/PrepaN.png' alt='CoyoTé'><br><br>
      <a href='inicioA.php'>Regresar</a>
    </form>
  </body>"; //Redirecciona a la página de inicio del administrador
?>
